"use strict";
(self["webpackChunkartesanias_lumar_backend"] = self["webpackChunkartesanias_lumar_backend"] || []).push([["polyfills"],{
 ...
 * BROWSER POLYFILLS
 */
window.global = window; // Run `npm install --save classlist.js`.   // Run `npm install --save web-animations-js`.
/**
